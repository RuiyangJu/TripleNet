...
from models import *
from models.TripleNet import triplenet
...
class Solver(object):
    ...
    def load_model(self):
        ...
        self.model = triplenet().to(self.device)

        self.optimizer = optim.SGD(self.model.parameters(), lr=self.lr, momentum=0.9, weight_decay=1e-4, nesterov=True)
